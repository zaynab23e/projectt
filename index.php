...
<?php
$select_s="SELECT * FROM category WHERE id ='1'";
$result_s=$conn->query($select_s);
$s=$result_s->fetch_assoc();
          ?>
...
<?php
$select_i="SELECT * FROM category WHERE id ='7'";
$result_i=$conn->query($select_i);
$i=$result_i->fetch_assoc();
          ?>
...
<?php
$select_w="SELECT * FROM category WHERE id ='5'";
$result_w=$conn->query($select_w);
$w=$result_w->fetch_assoc();
          ?>




            <div class="col-md-4 mb-4 mb-md-0"><a class="category-item" href="shop.php?cid=<?=$ca['id']?>"><img class="img-fluid" src="img/cat-img-1.jpg" alt=""><strong class="category-item-title">Clothes</strong></a></div>
            <div class="col-md-4 mb-4 mb-md-0"><a class="category-item mb-4" href="shop.php?cid=<?=$s['id']?>"><img class="img-fluid" src="img/cat-img-2.jpg" alt=""><strong class="category-item-title">Shoes</strong></a><a class="category-item" href="shop.php?cid=<?=$w['id']?>"><img class="img-fluid" src="img/cat-img-3.jpg" alt="">
            
            <strong class="category-item-title">Watches</strong></a></div>
            <div class="col-md-4"><a class="category-item" href="shop.php?cid=<?=$i['id']?>"><img class="img-fluid" src="img/cat-img-4.jpg" alt=""><strong class="category-item-title">Electronics</strong></a></div>
          </div>
        </section>
        <!-- TRENDING PRODUCTS-->
        <section class="py-5">

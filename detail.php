...
$select_P="SELECT * FROM product WHERE id='$id' ";
$result_p=$conn->query($select_P);
$p=$result_p->fetch_assoc();

$oldview=$p['views'];
$newview = $oldview +1 ;
$up="UPDATE product SET views='$newview' WHERE id ='$id'";
$conn->query($up);
...
<?php
                  ...
                  {
                    ?>
                    <div class="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0"><img class="w-100" src="admin/imgs/<?=$im?>" alt="..."></div>
                ...
                <div class="col-sm-10 order-1 order-sm-2">
                  <div class="owl-carousel product-slider" data-slider-id="1"><a class="d-block" href="img/product-detail-1.jpg" data-lightbox="product" title="Product item 1">
                <?php 
                  $x=explode(",",$p['img']);
                  $imgs=$x;
                  foreach($imgs as $im)
                  ...
                  <img class="img-fluid" src="admin/imgs/<?=$im?>" alt="..."></a>  
            ...
            <div class="col-lg-6">
              ...
              <h1><?=$p['name']?></h1>
              <p class="text-muted lead">$<?=$p['price']?></p>
              <p class="text-small mb-4"> <?=$p['des']?> Vestibulum ultricies aliquam convallis.</p>
              <div class="row align-items-stretch mb-4">
                ...
                <div class="col-sm-3 pl-sm-0"><a class="btn btn-dark btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-0" href="cart.php?id=<?=$id?>">Add to cart</a></div>
              </div><a class="btn btn-link text-dark p-0 mb-4" href="#"><i class="far fa-heart mr-2"></i>Add to wish list</a><br>
              <ul class="list-unstyled small d-inline-block">
                <li class="px-3 py-2 mb-1 bg-white"><strong class="text-uppercase">views:</strong><span class="ml-2 text-muted"><?=$newview?></span></li>
...
<?php
$c=$p['cat'];
$select_c="SELECT * FROM category WHERE id='$c'";
...
?>
                ...
                <li class="px-3 py-2 mb-1 bg-white text-muted"><strong class="text-uppercase text-dark">avalible:</strong><a class="reset-anchor ml-2" href="#">
                <?=$p['count']>0 ?"in stock":"out of stock"?></a></li>
              </ul>
            </div>
          </div>
            <?php
...
?>
          ...
          <ul class="nav nav-tabs border-0" id="myTab" role="tablist">
            ...
            <li class="nav-item"><a class="nav-link" id="reviews-tab" data-toggle="tab" href="#add" role="tab" aria-controls="add" aria-selected="false">add reviews</a></li>
          </ul>
            ...
            <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
              <div class="p-4 p-lg-5 bg-white">
                <div class="row">
                  ...
                  <?php
$select="SELECT * FROM comment WHERE id_prod='$id' ";
$res=$conn->query($select);
while($prr=$res->fetch_assoc())
{
  ?>
<?php
$comm= $prr['comm'];
...
$select="SELECT * from browser  WHERE id= '$id_pp' ";
$resul=$conn->query($select);
$po=$resul->fetch_assoc();
//$po['firstname'];
...
?>
                    ...
                    <div class="media mb-3"><img class="rounded-circle" src="img/customer-1.png" alt="" width="50">
                      <div class="media-body ml-3">
                        ...
                        <p class="text-small mb-0 text-muted"><?=$comm?></p>
                      </div>
                    </div>
...
?>
            ...
            <div class="tab-pane fade" id="add" role="tabpanel" aria-labelledby="reviews-tab">
              <div class="p-4 p-lg-5 bg-white">
                <div class="row">
                  <div class="col-lg-8">
                    <form action="fun/add_comm.php?id=<?=$id?> " method="POST">

...
<html>
  ...
  <body>
    <div class="page-holder">
     ...
     $select="SELECT * FROM browser WHERE id ='$n'";
...
echo"<i class='fas fa-user-alt mr-1 text-gray'></i>  $c <a href='logout.php'><button class='btn  btn-warning'><i class='fas fa-user-alt mr-1 text-gray'></i>logout</ button></a>";


                }else{echo"<a href='login.php'><i class='fas fa-user-alt mr-1 text-gray'></i> login</a>";}
